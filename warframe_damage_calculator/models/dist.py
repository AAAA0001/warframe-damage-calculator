...
from ..utils import PHYSICAL_TYPES, ELEMENTAL_TYPES, DAMAGE_TYPES, ELEMENTAL_COMBINATIONS, DAMAGE_TYPE_ORDER, DamageFields, DamageType
...
class dist:
    ...
    @property
    def dist(self) -> dict[DamageType, float]:
