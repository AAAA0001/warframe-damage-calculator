...
class Primary(Ranged):
    def __init__(self, base: PrimaryState | None = None, *, damage_dist: Dist | None = None, forced_procs: Dist | None = None, crit_chance: float = 0.0, crit_damage: float = 0.0, status_chance: float = 0.0, explosion_damage_dist: Dist | None = None, explosion_forced_procs: Dist | None = None, weakpoint_damage: float = 3.0, fire_rate: float = 0.0, charge_time: float = 0.0, reload_speed: float = 0.0, magazine_capacity: int = 0, multishot: float = 0.0, is_beam: bool = False) -> None:
