...
class PrimaryCalculator(RangedCalculator[PrimaryState]):
    ...
    def _compute_moded_stats(self) -> None:
        ...
        self.moded.fire_rate = max(self.base.fire_rate * (1 if self.build.fire_rate_lock else (1 + sum(upgrade.fire_rate * (2 if self.base.type == "bow" and upgrade.category == "mod" else 1) for upgrade in self.build))), 0.05)
