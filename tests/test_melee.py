...
from warframe_damage_calculator.damage_models import Melee
...
class MeleeTests(unittest.TestCase):
    def test_melee_specific_methods(self) -> None:
        ...
        self.assertAlmostEqual(weapon.average_duplicate_multiplier(), 1.45)
    ...
    def test_melee_raw_damage_formulas(self) -> None:
        ...
        self.assertAlmostEqual(weapon.flat_dph(), 631.8671875)
        self.assertAlmostEqual(weapon.flat_dps(), 884.6140625)
    ...
    def test_melee_dot_damage_formulas(self) -> None:
        ...
        self.assertAlmostEqual(weapon.flat_dotph(), 252.0)
        self.assertAlmostEqual(weapon.flat_dotps(), 302.4)
